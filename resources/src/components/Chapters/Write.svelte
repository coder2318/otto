<script lang="ts">
    ...
    function submit(event: SubmitEvent) {
        $form
            ...
            .post(`${routePrefix}/${chapter.data.id}`, {
                preserveScroll: true,
                onSuccess: () => {
                    $form
                        .defaults({
        ...
        $form
            ...
            .post(`${routePrefix}/${chapter.data.id}`, {
                ...
                onSuccess: () => {
                    ...
                    fetch(`${routePrefix}/${chapter.data.id}/translate/stream?${new URLSearchParams(data)}`, {
            ...
            <div class="card-body gap-4">
                ...
                <div class="flex flex-col justify-between gap-4 md:flex-row">
                    <div class="flex items-center gap-4">
                        <a href="{routePrefix}/{chapter.data.id}/edit" class="goBackLink" use:inertia>
                    ...
                    <div class="flex flex-col items-stretch gap-4 md:flex-row md:items-center">
                        ...
                        {:else}
                            <a
                                ...
                                href="{routePrefix}/{chapter.data.id}/finish"
                            >
                                Complete chapter
                            </a>

                            <a href="{routePrefix}/{chapter.data.id}/enhance" use:inertia>
