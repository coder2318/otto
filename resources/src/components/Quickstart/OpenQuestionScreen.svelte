<script lang="ts">
    ...
    function next() {
        ...
        flash({ message: 'Please choose an answer first!', type: 'alert-warning', autohide: true })
    }
</script>
...
<div class="flex flex-col h-full w-full items-center justify-center" in:fade>
    <div class="flex-1 flex flex-col items-center justify-center gap-8">
        ...
        <input type="text" class="input input-bordered text-center font-serif w-full input-lg" placeholder="Type your answer..." name="answer" id="answer" required bind:value={$form.quiz[question.id]}>
    </div>
