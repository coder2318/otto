...
>
    <div class="flex-1 flex flex-col items-left justify-center">
        <div class="form-control">
            <label
                class="label md:gap-4 font-serif flex-col items-start md:flex-row whitespace-nowrap"
            >
                <span class="label-text text-2xl lg:text-6xl md:text-5xl"
                ...
                <input
                    ...
                    class="input md:input-ghost md:px-0 italic lg:input-lg text-3xl lg:text-6xl md:text-5xl w-full"
                    name="first_name"
                    id="first_name"
                    required
                />
