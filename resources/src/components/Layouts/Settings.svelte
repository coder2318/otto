...
<section class="container mx-auto my-8 flex items-center gap-2 px-4 text-primary">
...
<section class="container drawer mx-auto px-4 lg:drawer-open lg:gap-8">
    ...
    <div class="drawer-side max-lg:z-30 lg:h-auto">
        ...
        <ul class="menu menu-lg min-h-full w-80 gap-4 text-base-content max-lg:bg-base-200 lg:p-0">
