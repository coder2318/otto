...
class TimelineQuestion extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\TimelineQuestion>
     */
    public static $model = \App\Models\TimelineQuestion::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Medialibrary::make('Covers', 'cover')->accept('image/*')->showOnIndex(false),
